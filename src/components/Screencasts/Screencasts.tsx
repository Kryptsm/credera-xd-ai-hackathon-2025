...
const videos = [
	{
		title: 'Getting started with artifical intelligence',
		description:
			'Get familiar with ChatGPT, the different tools it offers, and the most important features.',
		image: setupImage,
	...
	},
	{
		...
		description:
			'Learn how to create a new model and configure your weights and rules for ideal responsiveness.',
		image: gridsImage,
		runtime: { minutes: 9, seconds: 12 },
	},
	{
		title: 'Designing your LLM',
		description:
			'Using basic coding and boolean operations, learn how to design your own LLM to rival ChatGPT and Gemini.',
		image: strokesImage,
	...
	},
	{
		...
		description:
			'Learn the techniques you need to know to adapt your LLM for enterprise use.',
		image: duotoneImage,
...
/**
 * Play icon for screencast video cards.
 *
 * @param {React.ComponentPropsWithoutRef<'svg'>} props - SVG props
 * @returns {JSX.Element} SVG play icon
 *
 * @example
 * <PlayIcon />
 */
...
/**
 * Screencasts section for video tutorials and learning resources.
 *
 * @component
 * @returns {JSX.Element} Screencasts section with video cards.
 *
 * @example
 * <Screencasts />
 */
		...
		>
			<Container>
				...
				<p className="mt-4 text-lg tracking-tight text-slate-700">
					Learn how to design your very first AI use case in a series of
					screencasts that will teach you everything you need to know to go from
					beginner to pro in just over an hour.
				</p>
			</Container>
